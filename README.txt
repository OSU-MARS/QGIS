...
You can use the data tab to decide which loaded layer is your data layer and training layer. As well as make an shp ROI file and select the directory where you want the results.
...
Unrealized Features:
Maximum-likelihood does not work as intended, it is not the actual ML algorithm that it shares a name with. This will be a requirement for a future group to over-haul this algorithm
